...
本指南用于在 OpenClaw Gateway 中接入 XiaoZhi WebSocket Channel（当前 npm 包：`@xiaozhi_openclaw/xiaozhi@0.0.5`）。
...
兼容性说明：OpenClaw `2026.3.8+` 请使用 `@xiaozhi_openclaw/xiaozhi@0.0.5`。
